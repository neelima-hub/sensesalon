...
const Hero = () => {
    ...
    return (
        <section ref={containerRef} className="relative w-full h-[100dvh] overflow-hidden flex items-center justify-center pt-24">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex flex-col justify-center h-full">
                <div ref={textRef} className="space-y-4 max-w-4xl">
                    <p className="hero-text-line font-sans text-champagneDark tracking-[0.2em] uppercase text-sm md:text-base font-semibold">
                        28th Floor, Oaks Liwa Heights, JLT
                    </p>
                    <h1 className="text-6xl md:text-8xl lg:text-9xl text-white leading-[1.1] tracking-tight">
                        <span className="block hero-text-line font-sans font-bold">Elevation meets</span>
                        <span className="block hero-text-line font-serif italic text-champagne mt-2">Elegance.</span>
                    </h1>
                    <p className="hero-text-line font-sans text-champagne/60 max-w-lg mt-8 text-lg font-light">
                        Panoramic views, precision styling, and a sanctuary of aesthetic refinement above the skyline of Dubai.
                    </p>
                </div>
            </div>

            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 z-10 hero-scroll-indicator flex flex-col items-center gap-2">
